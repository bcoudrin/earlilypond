...
(easy-menu-define LilyPond-skeletons-menu 
   ...
   (append '("Templates")
	   ...
	   '(("Ancient Music Templates" :visible LilyPond-ancient-templates-p
	       [ "Gregorian" LilyPond-gregorian :keysequence nil]
	       [ "Ancient Notation Style" LilyPond-neomensural :keysequence nil]
	       [ "Modern gregorian" LilyPond-gregorian-modern :keysequence nil]
	       ))
...
(font-lock-add-keywords 'LilyPond-mode '(("\\<\\(ANY\\|CHORDS\\|DYNAMICS\\|F\\(?:IVE\\|OUR\\)\\|INSERT\\|LYRICS\\|MORE\\|NOTES?\\|ONE\\|PART\\|REFRAIN\\|DRUMBEATS\\|SI\\(?:NGLE\\|X\\)\\|T\\(?:HREE\\|WO\\)\\)\\>" 1 font-lock-warning-face prepend))) 


(defvar LilyPond-mode-abbrev-table ; I put some "help" in the menus for these.
...
;;; Another idea is to make a template wizard like I imagine lilypondtools works and
