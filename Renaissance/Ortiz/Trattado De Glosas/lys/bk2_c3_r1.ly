...
DAcantusNotes = {g1 g a a g g fis f g g a a g2 g1 fis2 g1 g}
DAcantusSettings = {
...
DAcantusUrtext = \relative c'' {
  \DAcantusSettings
  \repeat volta 2 {\DAcantusNotes}
  \cadenzaOff
}

DAaltusNotes = {d1 d f f d d d d d d f f d2 e d1 d d}
DAaltusSettings = {
...
DAaltusUrtext = \relative c' {
  \DAaltusSettings
  \repeat volta 2 {\DAaltusNotes}
  \cadenzaOff
}

DAtenorNotes = {bes1 bes c c bes bes a a bes bes c c bes2 c a1 g g}
DAtenorSettings = {
...
DAtenorUrtext =  \relative c' {
 \DAtenorSettings 
  \repeat volta 2 {\DAtenorNotes}
  \cadenzaOff
}

DAbassusNotes = {g1 g f f g g d d g g f f g2 c, d1 g, g}
DAbassusSettings = {
...
DArecercada = \relative c' {
  ...
  \clef bass a4 g fis e d c bis c d c bes a g2 d''1 bes2 c2. bes4 a g a2 g bes1 g2 a2. g4 fis e f2 g d'1 bes2 c2. bes4 a g a2 \bar "" \urtextBreak
  \clef #(if (eqv? (ly:get-option 'urtext) #t)
               "tenor"
  ...
  \time 3/1 a4. bes8 c4 f,4. g8 a4 bes4. c8 d4 bes g bes a4. g8 a4 fis4. e8 f4 \time 4/4 g2. a4 bes c d bes c bes a g a bes c a \bar "" \urtextBreak
